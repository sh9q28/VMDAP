...
parser.add_argument('--input_dir', default="/data2/ssh/light_shield_net/Restormer-main/Deraining/Datasets/DIAS_gen/train0_deep_mask/", type=str, help='Directory of input images or path of single image')
parser.add_argument('--result_dir', default="/data2/ssh/light_shield_net/VDGN/test/", type=str, help='Directory for restored results')
...
def get_weights_and_parameters(task, parameters):
    if task == 'Motion_Deblurring':
        ...
        weights = os.path.join('VesselGen', 'pretrained_models', 'deraining.pth')
...
#model = load_arch['DEMGenFtormer1'](**parameters)

device = torch.device('cuda' if torch.cuda.is_available() else 'cpu')
model.to(device)

checkpoint = torch.load("/data2/ssh/light_shield_net/Restormer-main/experiments/Vessel_gen_50k/models/net_g_500.pth")
