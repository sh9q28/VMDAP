...
parser.add_argument('--input_dir', default="ADGN/VesselGen/Datasets/input/", type=str, help='Directory of input images or path of single image')
parser.add_argument('--result_dir', default="ADGN/test/", type=str, help='Directory for restored results')
...
checkpoint = torch.load("ADGN/experiments/Vessel_gen_50k/models/.pth")
